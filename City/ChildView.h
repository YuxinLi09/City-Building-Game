...
private:
    ...
    bool mChecked = false; ///< Flag to see if the prune button is checked 
    bool mShowHistory = false; ///< Flag to see if view mouse history button is checked 
...
public:
    ...
    afx_msg void OnUpdateGardenPrune32809(CCmdUI* pCmdUI);
    afx_msg void OnGardenPrune32809();
    afx_msg void OnGardenPruneall32810();
