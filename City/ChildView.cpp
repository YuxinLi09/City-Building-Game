...
BEGIN_MESSAGE_MAP(CChildView, CWnd)
    ...
    ON_COMMAND(ID_Menu, &CChildView::OnLandscapingGarden)

    ON_UPDATE_COMMAND_UI(ID_GARDEN_PRUNE32809, &CChildView::OnUpdateGardenPrune32809)
    ON_COMMAND(ID_GARDEN_PRUNE32809, &CChildView::OnGardenPrune32809)
    ON_COMMAND(ID_GARDEN_PRUNEALL32810, &CChildView::OnGardenPruneall32810)
...
/**
*  Add a CGarden tile to the drawing.
*/
...
/** Checked menu handler that prune the garden 
  * \param pCmdUI menu object */
void CChildView::OnUpdateGardenPrune32809(CCmdUI* pCmdUI)
{
    pCmdUI->Enable(true); // Will disable the menu option
    pCmdUI->SetCheck(mChecked);	// Will check the menu option
}

/** Menu handler that prune the garden */
void CChildView::OnGardenPrune32809()
{
    mChecked = !mChecked;
}

/** Menu handler that prune all of the garden */
void CChildView::OnGardenPruneall32810()
{
    CPruneGarden visitor;
    mCity.Accept(&visitor);
}

/** Checked menu handler that view the mouse history 
  * \param pCmdUI menu object */
...
/** Menu handler that view the mouse history */
